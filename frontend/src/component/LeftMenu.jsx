...
export default function LeftMenu() {
  ...
  return (<>
    ...
    <div className={`capitalize ${isMenuClicked?' w-[200px] md:w-[300px]':'w-10 h-[0px] '} transition-all duration-1000 ease-in-out text-white text-sm bg-dark flex-col flex justify-between  h-[100vh] absolute md:relative `}>

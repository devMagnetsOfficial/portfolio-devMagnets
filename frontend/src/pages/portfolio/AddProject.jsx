...
export default function AddProject({onChange,addProjectsOnSubmit ,selectProject,setSelectProject}) {
    return (<>
        ...
        <form onSubmit={addProjectsOnSubmit} className="mb-5 bg-card p-5 gap-5 md:gap-10 min-h-[49vh] flex flex-col absolute h-fit md:w-[50vw] inset-0 m-10 md:m-auto z-[120]">
            ...
            <label htmlFor="title" className="flex items-center">
                ...
                <input className="bg-darkGray w-full h-10 pl-4 text-white/80 " type="text" onChange={onChange} name="title" id="title" placeholder="Title" />
            </label>
            <label htmlFor="description" className="flex items-center">
                <div className="w-10 h-10 bg-dark  flex items-center justify-center"><MdOutlineDescription className="text-lg " /></div>
                <input className="bg-darkGray w-full h-10 pl-4 text-white/80" type="text" onChange={onChange} name="description" id="description" placeholder="Description" />
            </label>
            <label htmlFor="link" className="flex items-center">
                ...
                <input className="bg-darkGray w-full h-10 pl-4 text-white/80" type="text" onChange={onChange} name="link" id="link" placeholder="Link" />
            </label>
            <label htmlFor="img" className="flex items-center">
                ...
                <input className="bg-darkGray w-full h-10 pl-4 text-white/80" type="text" onChange={onChange} name="img" id="img" placeholder="Img" />
            </label>

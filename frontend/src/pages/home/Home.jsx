...
export default function Home() {
    return (<>
        <div className=" bg-dark h-[100vh] p-4 md:p-8">
            <div className=" min-h-[50%] grid md:grid-cols-[1.5fr_1fr] grid-cols-1 border-2">
                <div className=" flex flex-col justify-around md:p-[60px]">
                    <div className="text-5xl text-textPrimary text-center ">
                        Discover my Amazing Art Space!
                    </div>
                    <div className="text-textPrimary italic"> &lt; <span className="text-accent">code</span> &gt;
                        I build {" "}
                        <ReactTyped className='text-textSecondary' strings={["MERN Stack Developer ",
                            "React Enthusiast ",
                            "Open Source Contributor "]} typeSpeed={100} backSpeed={100} loop />

                        &lt; <span className="text-accent">code</span> &gt; </div>
            ...
            <div className=" min-h-[10%] grid grid-cols-2 md:grid-cols-4">
